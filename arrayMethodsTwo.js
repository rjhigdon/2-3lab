...
let coolCities = cities.filter(place => place.endsWith('i') !== true)
...
// CODE HERE
 ...
 fruits.forEach((fruit, index) => {
  ...
  if(fruit.color === 'orange'){
    ...
    console.log(`The fruit with index ${index} is an neither and orange or apple`)
  }    
 })
...
'The fruit with index 0 is an neither and orange or apple'
'The fruit with index 1 is an orange'
'The fruit with index 2 is an neither and orange or apple'
'The fruit with index 3 is an apple'
'The fruit with index 3 is an neither and orange or apple'
...
let ricePrice = foods
.filter(item => item.tags.includes('rice'))
.reduce((acc, foods) => acc + foods.price, 0)
